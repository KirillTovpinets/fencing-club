<?php
  ...
  wp_enqueue_script(
    'main',
    get_template_directory_uri() . '/js/main-1.js',
    array(),
      '1.0.0',
    array(
      'strategy'  => 'defer',
 ...
 function add_direction_link_imap_field_to_general_admin_page() {
  $option = 'club-direction-link-imap';
    register_option_function($option, 'Club Direction iMap Link');
 }
