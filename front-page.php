...
<header class="fencing-header d-flex align-items-center justify-content-center flex-column gap-4" style="background-image: url('<?php echo bloginfo('template_url');?>/images/backgrounds/header.png')">
    ...
    <a href="#" class="btn fencing-btn btn-xlg rounded-pill">Get started today</button>
  </header>
    ...
    <div class="container">
      <div class="row align-items-center flex-md-row flex-column-reverse">
        <div class="col-md-6 mb-md-0 mb-5">
          ...
          <a href="#" class="text-uppercase btn btn-outline-light btn-xlg rounded-pill fencing-btn-outline">Get Involved</button>
        </div>
        <div class="col-md-6">
  ...
  <section class="fencing-section py-5 bg-primary">
    ...
    <div class="container">
      ...
      <div class="text-center">
        <a href="#" class="btn fencing-btn rounded-pill btn-xlg text-uppercase">Get Started today</button>
      </div>
    </div>
