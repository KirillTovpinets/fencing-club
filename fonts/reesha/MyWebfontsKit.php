...
/*
Plugin Name: MyWebfontsKit #701500
...
add_action( 'admin_init', array('MonotypeInstaller_701500','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MonotypeInstaller_701500','monotype_loadupWebfonts' ));
